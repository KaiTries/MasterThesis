...
<http://localhost:8005/protocol_descriptions/buytwo_protocol> a bspl:ProtocolDescription;
    bspl:ProtocolName "Buy";
    bspl:descriptionOf <http://localhost:8005/protocols/buy_two_protocol> ;
    bspl:initialMessage "HandShake".

<http://localhost:8005/protocols/buy_two_protocol> a bspl:Protocol;
    bspl:hasRole <http://localhost:8005/protocols/buy_two_protocol#BuyerRole> ,
                 <http://localhost:8005/protocols/buy_two_protocol#SellerRole> .

# Semantic Role Descriptions for autonomous role reasoning

<http://localhost:8005/protocols/buy_two_protocol#BuyerRole>
    a bspl:Role ;
    bspl:roleName "Buyer" ;
    bspl:hasGoal gr:seeks ;
    bspl:requiresCapability "Pay" ;
    bspl:sendsMessage "HandShake" ;
    bspl:receivesMessage "Give" ;
    rdfs:comment "The Buyer acquires items by providing payment. This role is suitable for agents whose goal is to buy/acquire artifacts." ;
    rdfs:label "Buyer" .
...
@app.route('/protocol_descriptions/buytwo_protocol', methods=['GET'])
def callback_protocol_description_two():
    return bspl_rdf_two, 200
