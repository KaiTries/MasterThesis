...
class Store:
    ...
    def add_context(self, system_id):
        if system_id not in self.contexts:
            self.contexts[system_id] = Context()
    
    def remove_context(self, system_id):
        self.contexts.pop(system_id, None)
